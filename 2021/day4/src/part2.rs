...
pub fn part2(input: String) {
    let mut boards: Vec<[u32; 25]> = vec![[0u32; 25]];
    ...
    let outcome: Option<Outcome> = {
        ...
        let mut matches = vec![[true; 25]; boards.len()];
        let mut not_bingo = false;
    ...
    match outcome {
        Some(o) => println!(
            ...
            o.unmarked_numbers,
            unsafe {
                o.winning_number.mul(
                    o.unmarked_numbers
                        .iter()
                        .sum::<u32>()
                        .unchecked_sub(o.winning_number),
                )
            }
        ),
